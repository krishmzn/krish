...
const techList: TechListType[] = [
  {
    techVid: '/techstack/resume-analyzer-api.mp4',
  ...
  {
    techVid: '/techstack/online-store.mp4',
  ...
  {
    techVid: '/techstack/resume-analyzer-postman.mp4',
    techName: 'Java',
...
export default function TechStackList() {
  return (
    <section className="max-w-7xl p-5 mx-auto">
      <h2 className="font-black text-5xl tracking-tighter w-full text-center mb-1 drop-shadow-2xl">Projects.</h2>
